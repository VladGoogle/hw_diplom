...
export class Migrations1634129495998 implements MigrationInterface {
    name = 'Migrations1634129495998'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "mod_to_product_to_order" ("id" SERIAL NOT NULL, "totalProductPrice" integer NOT NULL, "productorderId" integer, "modifierId" integer, "orderId" integer, CONSTRAINT "PK_997d3a6bcfb004fce3a82193204" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "totalPrice" integer NOT NULL, "tax" integer NOT NULL, "status" text NOT NULL, "isMods" boolean NOT NULL, "userId" integer, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "transaction" ("id" SERIAL NOT NULL, "source" character varying NOT NULL, "amount" integer, "status" text NOT NULL, "currency" character varying NOT NULL, "description" character varying NOT NULL, "customer_token" character varying NOT NULL, "cardId" integer, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "mod_to_product_to_order" ADD CONSTRAINT "FK_3208f8be74665d82d2c04a33b0b" FOREIGN KEY ("orderId") REFERENCES "order"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "mod_to_product_to_order" DROP CONSTRAINT "FK_3208f8be74665d82d2c04a33b0b"`);
