...
@Module({
  imports: [TypeOrmModule.forRoot(
      {
        ...
        database: "pg_users",
        entities: [User, Card, Category, Label, Modifier, Order, Product, ProductOrder, ModToProd, ModToProductToOrder, Transaction],
  ...
  ), UsersModule, AuthModule, ModifiersModule, LabelModule, CategoryModule, ProductModule, ModtoprodModule, CardModule, OrderModule, ProductorderModule, ModproductorderModule, TransactionModule, StripeModule],
